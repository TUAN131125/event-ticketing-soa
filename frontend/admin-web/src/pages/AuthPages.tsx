    ...
    <div className="auth-layout">
      <div className="auth-panel">
        ...
        <div className="auth-copy">
          ...
          <p>
            Sign in with an administrator or operator account to manage events,
            bookings and service health.
          </p>
        </div>
        <form
          className="auth-form"
        ...
        <p className="auth-note">
          <ShieldCheck size={16} /> Sessions use short-lived access tokens and
      ...
      <div className="auth-aside">
        ...
        <p>
          Keep inventory, payments and customer care aligned as tickets move
          from publish to check-in.
        </p>
      </div>
    </div>
  );
