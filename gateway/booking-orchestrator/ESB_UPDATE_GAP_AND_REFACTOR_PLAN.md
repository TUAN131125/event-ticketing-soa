...
Trước bản V4, browser gọi Identity Service riêng. Bản V4 đã chọn phương án A: frontend chỉ gọi `/api/auth/*` trên ESB; ESB proxy đúng năm operation canonical tới Identity và bảo toàn cookie/CSRF.
