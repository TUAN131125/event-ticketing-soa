...
class CancelBooking(BookingTransition):
    scope: ClassVar[str] = "CancelBooking"
    ...
    def is_already_applied(self, booking: Booking) -> bool:
        if booking.status not in {
            ...
            return False
        if booking.cancellation_reason != self.reason:
            raise InvalidRequest("Booking already records another cancellation reason")
